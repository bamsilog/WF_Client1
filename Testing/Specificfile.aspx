            ...
            <div class="col-sm-auto  sticky-top custom-column-spacing">
                <div class="d-flex flex-sm-column flex-row flex-nowrap  align-items-center sticky-top">
                    ...
                    <ul class="nav nav-pills nav-flush flex-sm-column flex-row flex-nowrap mb-auto mx-auto text-center align-items-center">
                        ...
                        <h6><center>Controlled<br /> Combinations</center></h6>
                        <li class="nav-item">
                        ...
                        <div class="row-lg-7"  >
                            <div class="tab-content" >
                                        ...
                                        <div id="combi" class=" tab-pane fade" role="tabpanel" aria-labelledby="combine">
                                             <iframe src="specifiles/combinations.aspx" style="width:1280px; height:530px; border:none; "></iframe>
                                        </div>
                                        <div id="lowcombi" class=" tab-pane fade" role="tabpanel" aria-labelledby="lowb">
                                             <iframe src="specifiles/lowcombi.aspx" style="width:1300px; height:550px; border:none; "></iframe>
                                        </div>
                                        ...
                                        <div id="salesrep" class=" tab-pane fade" role="tabpanel" aria-labelledby="salesr">
                                               <iframe src="specifiles/salrep.aspx" style="width:1300px; height:550px; border:none;  "></iframe>
                                        </div>
                            </div>
</div>
                    </div>
