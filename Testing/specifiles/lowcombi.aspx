<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="lowcombi.aspx.cs" Inherits="Testing.specifiles.WebForm1" %>
                  ...
                  <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-3">
                            ...
                            <select id="codeop" name="codeops"  style="width:230px; height:30px;">
